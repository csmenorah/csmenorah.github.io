          ...
          <ul className="list-unstyled d-flex flex-1 gap-3 m-0">
            {currentUserDetails.displayName && (
              <>
                <li>
                  ...
                  >
                    {`Welcome ${currentUserDetails.displayName},`}
                  </Link>
                </li>
                <li>
                  <a
            ...
            <li>
              <a href="#" className="menu-link menu-link_us-s fs-13">
                Help Service <span>{` |`}</span>
              </a>
            </li>
            <li>
              <a href="/faq" className="menu-link menu-link_us-s fs-13">
                FAQ
              </a>
            </li>
          </ul>
...
{/*
                  ...
                  <div className="header-tools__item text-white d-xxl-block">
                    <a
                      href="/"
                      className="fs-15 fw-semi-bold text-uppercase"
                      style={{
                        background: "none",
                        outline: "none",
                        border: "none",
